...
function Footer() {
  ...
  <footer id="dk-footer" className="dk-footer" style={{backgroundColor:" white", color:"black",padding:"95px 0 0 "}}>
    <div className="container">
      <div className="row" style={{backgroundColor:"#878787",color:"black"}}>
      
        <div className="col-md-12 col-lg-4">
          <div className="dk-footer-box-info" style={{marginTop: "37px",backgroundColor:"white", color:"black", height:"265px"}}>
